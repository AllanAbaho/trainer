                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Mr. Kasule Thomas"
                                            id="user-email" name="instructor"value="{{ $course->instructor }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="category"
                                            ...
                                            <option value="Health" {{ $course->category == 'Health' ? 'selected' : '' }}>
                                                Health</option>
                                            <option value="Technology"
                                                {{ $course->category == 'Technology' ? 'selected' : '' }}>
                                                Technology</option>
                                            <option value="Accounting"
                                                {{ $course->category == 'Accounting' ? 'selected' : '' }}>
                                                Accounting</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="level"
                                            ...
                                            <option value="Intermediate"
                                                ...
                                                Intermediate</option>
                                            <option value="Expert" {{ $course->level == 'Expert' ? 'selected' : '' }}>
                                                Expert</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="www.youtube.com/xyz"
                                            id="user-name" name="video_url" value="{{ $course->video_url }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
